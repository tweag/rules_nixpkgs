...
let
  ...
  nixpkgs = import <nixpkgs> {
    ...
    crossOverlays = [
      (self: super: {
        ...
        llvmPackages_16 = super.llvmPackages_16.extend (final: prev: rec {
          libllvm = prev.libllvm.overrideAttrs (old: {
            ...
            LDFLAGS = "-L ${super.llvmPackages_16.libcxxabi}/lib";
          ...
          libraries = super.llvmPackages_16.libraries;
        });
      })
    ];
  };
  ...
  packages = [pkgsLinux.boost pkgsLinux.zlib pkgsLinux.bash nixpkgs.stdenv.cc.cc.lib];
